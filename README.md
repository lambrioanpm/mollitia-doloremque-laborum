...
<p align="center">
  <a href="https://www.npmjs.com/package/@lambrioanpm/mollitia-doloremque-laborum"><img src="https://img.shields.io/npm/dm/@lambrioanpm/mollitia-doloremque-laborum.svg" alt="Downloads"></a>
  <a href="https://www.npmjs.com/package/@lambrioanpm/mollitia-doloremque-laborum"><img src="https://img.shields.io/npm/v/@lambrioanpm/mollitia-doloremque-laborum.svg" alt="Version"></a>
  <a href="https://www.npmjs.com/package/@lambrioanpm/mollitia-doloremque-laborum"><img src="https://img.shields.io/npm/l/@lambrioanpm/mollitia-doloremque-laborum.svg" alt="License"></a>
</p>
...
```bash
npm i --save-dev @lambrioanpm/mollitia-doloremque-laborum
```
...
{   
    "presets": [ "es2015" ],
    "plugins": [["@lambrioanpm/mollitia-doloremque-laborum", {"imports": true}]]
}
```
...
React.Fragment is also compiled to inferno createFragment call to ease project migration to Inferno https://github.com/infernojs/@lambrioanpm/mollitia-doloremque-laborum/issues/56.
...
#### Imports (boolean)
@lambrioanpm/mollitia-doloremque-laborum will automatically import the required methods from inferno library.
...
You can verify `@lambrioanpm/mollitia-doloremque-laborum` is used by looking at the compiled output.
